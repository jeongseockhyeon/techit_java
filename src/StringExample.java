...
//        String str_2 = new String("안녕하세요!"); //생성자, 문자열 객체
//        String str_3 = "안녕하세요!";

//        if (str == str_2) {//힙메모리 비교
//            System.out.println(true);
//        } else {
//            System.out.println(false);
//        }
//        if (str == str_3) {//힙메모리 비교
//            System.out.println(true);
//        } else {
//            System.out.println(false);
//        }
//        if (str_2 == str_3) {//힙메모리 비교
//            System.out.println(true);
//        } else {
//            System.out.println(false);
//        }

//        if (str.equals(str_2)){ //값비교
//            System.out.println("str.equals(str_2)");
//        }
//        if (str.equals(str_3)){ //값비교
//            System.out.println("str.equals(str_3)");
//        }
//        if (str_2.equals(str_3)){ //값비교
...
//        System.out.println(str_1 +' '+ str_2);
        ...
        // 2. StringBuilder 속도면에서 빠르고 메모리면에선 효율적으로 작업 가능
...
//            System.out.println("str_1.equlas(str_2)");
//        }
